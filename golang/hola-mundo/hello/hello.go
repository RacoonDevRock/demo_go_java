...
// encore: api public path=/sum/:num1/:num2
func Sum(ctx context.Context, num1 int64, num2 int64) (*ResponseSumController, error)  {
	return &ResponseSumController{Sum: num1 + num2}, nil
}
...
type ResponseSumController struct {
	Sum int64
}
